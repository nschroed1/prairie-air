...
export const contracts: readonly Contract[] = [
  {
    ...
    target: 80,
    bonusTarget: 95,
    note: 'Our corn along Yew Avenue could use a little lift. Nice, even passes will do the trick.',
    difficulty: 'Easy going',
  },
  {
    id: 1,
    name: 'Yew & 290th Crosswind Run',
    ...
    windStrength: 3.5,
    briefing:
      'A soybean plot northwest of 290th Street with a clipped northeast corner and a stronger west wind. Aim upwind, shorten the eastern passes, and keep the whole spray footprint inside the flags.',
    pay: 1650,
    bonus: 600,
    target: 85,
    bonusTarget: 96,
    note: 'The prairie breeze is up. Keep your spray inside our soybean plot for a clean finish.',
    difficulty: 'Crosswind precision',
  },
  {
    id: 2,
    name: 'Ocheyedan River Valley Pasture',
    farmer: 'Ocheyedan Valley Co-op',
    crop: 'pasture',
    treatment: 'Fertilizer',
    x: -1020,
    z: 510,
    ...
    target: 90,
    bonusTarget: 98,
    note: 'Give our Ocheyedan Valley pasture some care. We pay extra for a beautifully even finish.',
